...
enum MessageInfoType
{
  ...
  // muos
    INFO_TYPE_MuosRlcPduListInfo,
    INFO_TYPE_MuosRlcSduInfo,
    INFO_TYPE_MuosRlcSduSegInfo,
    INFO_TYPE_MuosCellSwitch,
    INFO_TYPE_MuosGtpPdpInfo,   

    INFO_TYPE_MUOS_Um_Seq,
...
// /**
// CLASS :: MessageQueue
// DESCRIPTION :: Implements an efficient message queue.  The base
...
// DESCRIPTION :: Implements an efficient message queue.  This class
