...
enum
{
    ...
    MSG_MAC_MUOS_LAYER2_HandoffPacket          = 286,
...
// DESCRIPTION :: Timer structure used by applications to start listening
struct AppTcpListenTimer
{
...
// DESCRIPTION :: Timer structure used by applications to initiate
